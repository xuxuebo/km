<div class="pe-question-import-wrap pe-editor-all-wrap">
    <div class="pe-import-main-wrap">
        <div class="pe-upload-choose-area">
            ...
            <input type="hidden" value="" name="uploadAudioUrl"/>
            <input type="hidden" value="" name="audioId"/>
            <input type="hidden" value="" name="fileId"/>
            <input type="hidden" value="audio" name="uploaderType"/>
            <div id="uploader">
                <div class="pe-uploader-top-area">
                    <div id="dndArea" class="placeholder pe-uploader-holder-area">
                        <div class="pe-show-uploader-name-area floatL">
                            <span class="pe-uploader-tip-name floatL">上传文件</span>
                            <div class="pe-uploader-file-show-name placeholder-show-name floatL">请选择小于10M音频进行上传</div>
                        </div>
    ...
    $(function () {
        ...
        thisUpload.onUploadAccept = function (t, r) {
            if (r.success) {
                ...
                $('input[name="uploadAudioUrl"]').val(r.data.filePath);
                $('input[name="audioId"]').val(r.data.id);
                return true;
            } else {
