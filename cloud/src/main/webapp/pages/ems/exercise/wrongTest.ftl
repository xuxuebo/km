...
<div class="pe-container-main">
    <div class="pe-answer-nav-top">
        ...
        <dl>
            ...
            <dd><#if examResult.exam?? && examResult.exam.examSetting?? && examResult.exam.examSetting.examSetting.elt == 'LIMIT' && (examResult.exam.examSetting.examSetting.el>0) > ${(examResult.exam.examSetting.examSetting.el)!}
                分钟<#else>无限制</#if></dd>
        </dl>
    </div>
