...
import com.fp.cloud.utils.ReflectUtil;
...
public class PeGsonHttpMessageConverterBack extends AbstractHttpMessageConverter<Object>
     ...
     */
    public PeGsonHttpMessageConverterBack() {
    ...
    @Override
    public void write(Object o, Type type, MediaType contentType, HttpOutputMessage httpOutputMessage) throws IOException, HttpMessageNotWritableException {
        final HttpHeaders headers = httpOutputMessage.getHeaders();
        addDefaultHeaders(headers, httpOutputMessage, contentType);

        if (httpOutputMessage instanceof StreamingHttpOutputMessage) {
            StreamingHttpOutputMessage streamingOutputMessage = (StreamingHttpOutputMessage) httpOutputMessage;
