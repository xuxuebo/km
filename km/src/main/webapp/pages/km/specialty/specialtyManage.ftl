...
<section class="exam-manage-all-wrap">
    <form id="specialtyManageForm">
        <input type="hidden" name="libraryType" value="SPECIALTY_LIBRARY"/>
            ...
            <div class="pe-manage-panel pe-manage-default">
                <div class="pe-stand-table-panel">
                    <div class="pe-stand-table-top-panel">
                        <button type="button" class="pe-btn pe-btn-green create-exercise-btn">新增专业分类</button>
                    </div>
                            ...
                            PEBASE.ajaxRequest({
                                ...
                                success: function (data) {
                                    ...
                                    if (data.success) {
                                        ...
                                        $('.pe-stand-table-wrap').peGrid('load', $('#specialtyManageForm').serializeArray());
                                        return false;
