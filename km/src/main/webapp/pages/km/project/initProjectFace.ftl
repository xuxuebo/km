    ...
    function callback(res) {
        ...
        img.onload = function () {
            ...
            $('#target').Jcrop({
                ...
                boundary:0,
                boxWidth: 200,//设置裁剪区域的最大宽度
                boxHeight: 400//设置裁剪区域的最大高度
            }, function () {
    ...
    function save() {
        ...
        PEBASE.ajaxRequest({
            ...
            success: function (data) {
                if (data.success) {
                    $('.pe-user-head-edit-btn2', parent.document).children('img').attr('src', data.data.filePath);
