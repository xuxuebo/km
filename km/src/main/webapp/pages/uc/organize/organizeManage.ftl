...
<#--树状布局开始,可复用,记得调用下面的初始化函数;-->
    <form name="peFormSub" id="peFormSub">
        ...
        <#--复用时，保留下面的input单独classname 'pe-tree-form-text'-->
            <input class="pe-tree-form-text" type="text" placeholder="输入部门名称筛选">
    ...
    <#--节点id取值-->
        ...
        <input type="hidden" name="organize.organizeName" value="${(organize.organizeName)!}"/>
        <input type="hidden" name="organize.parentId" value="${(organize.parentId)!}"/>
    </form>
</div>
<#--编辑，新增对话框内容模板-->
    ...
    $(function () {
        ...
        var settingUrl = {
            ...
            optUrl: {
                ...
                moveUrl: pageContext.rootPath + '/uc/organize/manage/moveLevel',
                isNewNode: false
            },
            clickNode:function(){},
            ...
            addNodeFunc: function (zTree, treeNode) {
                PEMO.DIALOG.confirmL({
                    ...
                    btn1: function () {
                        ...
                        PEBASE.ajaxRequest({
                            url: pageContext.rootPath + '/uc/organize/manage/save',
                            data: {
                ...
                PEMO.DIALOG.confirmL({
                    ...
                    btn1: function () {
                        ...
                        PEBASE.ajaxRequest({
                            ...
                            url: pageContext.rootPath + '/uc/organize/manage/update',
                            data: {
                                'id': id,
                                'organizeName': organizeName,
                                'parentId': parentId
