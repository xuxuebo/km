...
vjs.Slider.prototype.update = function(){
  ...
  if (handle) {
    ...
    if($(handle.el()).eq(0).hasClass('vjs-volume-handle') && adjustedProgress == 1){
...
vjs.SliderHandle.prototype.createEl = function(type, props) {
  props = props || {};
  // Add the slider element class to all sub classes
  props.className = props.className + ' vjs-slider-handle iconfont icon-big-dot';
  props = vjs.obj.merge({
...
vjs.PlayToggle.prototype.buildCSSClass = function(){
  return 'vjs-play-control iconfont icon-start ' + vjs.Button.prototype.buildCSSClass.call(this);
};
...
vjs.PlayToggle.prototype.onPlay = function(){
  vjs.removeClass(this.el_, 'vjs-paused');
  vjs.removeClass(this.el_,'icon-start');
  vjs.addClass(this.el_, 'vjs-playing');
  vjs.addClass(this.el_,'icon-stop');
...
vjs.PlayToggle.prototype.onPause = function(){
  vjs.removeClass(this.el_, 'vjs-playing');
  vjs.removeClass(this.el_,'icon-stop');
  vjs.addClass(this.el_, 'vjs-paused');
  vjs.addClass(this.el_,'icon-start');
...
vjs.FullscreenToggle.prototype.buildCSSClass = function(){
  return 'vjs-fullscreen-control iconfont icon-start-fullscreen ' + vjs.Button.prototype.buildCSSClass.call(this);
};
...
vjs.FullscreenToggle.prototype.onClick = function(){
  ...
  if (!this.player_.isFullScreen()) {
    ...
    $('#peVideoPlayer').find('.vjs-fullscreen-control').removeClass('icon-start-fullscreen').addClass('icon-cancel-fullscreen');
    this.el_.children[0].children[0].innerHTML = 'Non-Fullscreen'; // change the button text to "Non-Fullscreen"
  } else {
    this.player_.cancelFullScreen();
    $('#peVideoPlayer').find('.vjs-fullscreen-control').removeClass('icon-cancel-fullscreen').addClass('icon-start-fullscreen');
...
vjs.MuteToggle.prototype.createEl = function(){
  return vjs.Button.prototype.createEl.call(this, 'div', {
    className: 'vjs-mute-control iconfont icon-pe-audio vjs-control',
...
vjs.MuteToggle.prototype.update = function(){
  ...
  if(this.player_.muted()){
      if(this.el_.children[0].children[0].innerHTML!='Unmute'){
         $('#peVideoPlayer').find('.vjs-mute-control').removeClass('icon-pe-audio').addClass('icon-mute-audio');
          this.el_.children[0].children[0].innerHTML = 'Unmute'; // change the button text to "Unmute"
      }
  } else {
      if(this.el_.children[0].children[0].innerHTML!='Mute'){
        $('#peVideoPlayer').find('.vjs-mute-control').removeClass('icon-mute-audio').addClass('icon-pe-audio');
...
vjs.LoadingSpinner.prototype.createEl = function(){
  return vjs.Component.prototype.createEl.call(this, 'div', {
    className: 'vjs-loading-spinner iconfont icon-loading'
  });
};
/* Big Play Button
================================================================================ */
...
vjs.BigPlayButton.prototype.createEl = function(t){
  var _this = this;
  if(_this.id().toString().indexOf('peAudioPlayer') >= 0){
    return false;
  }else{
    return vjs.Button.prototype.createEl.call(this, 'div', {
      className: 'vjs-big-play-button iconfont icon-start',
...
vjs.CloseVideoBtn = vjs.Component.extend({
  init: function(player, options, ready){
    vjs.Component.call(this, player, options, ready);
  }
});

vjs.CloseVideoBtn.prototype.createEl = function(){
  return vjs.Component.prototype.createEl.call(this, 'a', {
    className: 'video-close-btn iconfont icon-dialog-close-btn'
  });
};
    ...
    for (var i=0,j=vids.length; i<j; i++) {
      ...
      if (vid && vid.getAttribute) {
        ...
        if (vid['player'] === undefined) {
          ...
          optionsType = vid.getAttribute('data-type');
