...
function RecordRTC(mediaStream, config) {
    ...
    var returnObject = {
         ...
         *
         *     // or manually:
         *     invokeSaveAsDialog(this.getBlob(), 'filename.mp4');
         * });
         */
...
// animation-frame used in mp4 recording
 ...
 * @param {string} fileName - Optional file name e.g. "Recorded-Video.mp4"
 * @example
...
function invokeSaveAsDialog(file, fileName) {
    ...
    var fileFullName = (fileName || (Math.round(Math.random() * 9999999999) + 888888888)) + '.webm';
...
function MediaStreamRecorder(mediaStream, config) {
    ...
    if (config.type === 'audio') {
        ...
        if (!config.mimeType || config.mimeType.toString().toLowerCase().indexOf('audio') === -1) {
            config.mimeType = isChrome ? 'audio/mp4' : 'audio/ogg';
        }
    ...
    this.record = function() {
        ...
        if (typeof MediaRecorder.isTypeSupported === 'function' && recorderHints.mimeType) {
            if (!MediaRecorder.isTypeSupported(recorderHints.mimeType)) {
                ...
                recorderHints.mimeType = config.type === 'audio' ? 'audio/mp4' : 'video/webm';
            }
        }
...
/**
 * CanvasRecorder is a standalone class used by {@link RecordRTC} to bring HTML5-Canvas recording into video mp4. It uses HTML2Canvas library and runs top over {@link Whammy}.
 * @summary HTML2Canvas recording into video mp4.
 * @license {@link https://github.com/muaz-khan/RecordRTC#license|MIT}
 * @author {@link http://www.MuazKhan.com|Muaz Khan}
...
// todo: Firefox now supports webp for mp4 containers!
// their MediaRecorder implementation works well!
// should we provide an option to record via Whammy.js or MediaRecorder API is a better solution?

/**
 * Whammy is a standalone class used by {@link RecordRTC} to bring video recording in Chrome. It is written by {@link https://github.com/antimatter15|antimatter15}
 * @summary A real time javascript mp4 encoder based on a canvas hack.
 * @license {@link https://github.com/muaz-khan/RecordRTC#license|MIT}
 * @author {@link http://www.MuazKhan.com|Muaz Khan}
 * @typedef Whammy
 * @class
...
var Whammy = (function() {
    ...
    function whammyInWebWorker(frames) {
        ...
        var mp4 = new ArrayTomp4(frames.map(function(frame) {
    ...
    /**
     * Encodes frames in mp4 container. It uses WebWorkinvoke to invoke 'ArrayTomp4' method.
     * @param {function} callback - Callback function, that is used to pass recorded blob back to the callee.
     * @method
     * @memberof Whammy
     * @example
