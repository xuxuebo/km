...
import com.qgutech.pe.module.ems.model.JudgeUser;
...
public interface JudgeUserService extends BaseService<JudgeUser> {
     ...
     *                     <ul>
     *                     <li>{@linkplain com.qgutech.pe.module.ems.model.Exam#id 考试Id}</li>
     *                     <li>{@linkplain User#id 用户Id}</li>
     *                     <li>{@linkplain com.qgutech.pe.module.ems.model.ExamUser#referType 关联类型{@see ExamUserRelType}}</li>
     *                     </ul>
     ...
     *                     <ul>
     *                     <li>{@linkplain com.qgutech.pe.module.ems.model.JudgeUser.JudgeType#ITEM 试题}</li>
     *                     <li>{@linkplain com.qgutech.pe.module.ems.model.JudgeUser.JudgeType#PAPER 试卷}</li>
     *                     </ul>
