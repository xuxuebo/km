package com.qgutech.pe.module.sfm.service;
...
public interface FileServerService extends BaseService<PeFile> {
     ...
     *               <ol>
     *               <li>{@linkplain com.qgutech.pe.module.sfm.model.PeFile.FsType#COMMON 公用功能}</li>
     *               <li>{@linkplain com.qgutech.pe.module.sfm.model.PeFile.FsType#TEMPLATE 上传下载模板}</li>
     *               <li>{@linkplain com.qgutech.pe.module.sfm.model.PeFile.FsType#VIDEOTAPE 监控}</li>
     *               <li>{@linkplain com.qgutech.pe.module.sfm.model.PeFile.FsType#PHOTOGRAPH 学生答卷拍照}</li>
     *               </ol>
     *               </li>
     *               <li>{@linkplain PeFile#templateType 模板类型；不可为空}
     *               <ol>
     *               <li>{@linkplain com.qgutech.pe.module.sfm.model.PeFile.TemplateType#USER 用户模板}</li>
     *               <li>{@linkplain com.qgutech.pe.module.sfm.model.PeFile.TemplateType#ITEM 试题}</li>
     *               <li>{@linkplain com.qgutech.pe.module.sfm.model.PeFile.TemplateType#EXAM 考试}</li>
     *               </ol>
     *               </li>
     *               <li>{@linkplain PeFile#processorType 文件类型；不可为空}
     *               <ol>
     *               <li>{@linkplain com.qgutech.pe.module.sfm.model.PeFile.ProcessorType#VIDEO 视频}</li>
     *               <li>{@linkplain com.qgutech.pe.module.sfm.model.PeFile.ProcessorType#AUDIO 音频}</li>
     *               <li>{@linkplain com.qgutech.pe.module.sfm.model.PeFile.ProcessorType#IMAGE 图片}</li>
     *               <li>{@linkplain com.qgutech.pe.module.sfm.model.PeFile.ProcessorType#FILE 文件}</li>
     *               </ol>
     *               </li>
