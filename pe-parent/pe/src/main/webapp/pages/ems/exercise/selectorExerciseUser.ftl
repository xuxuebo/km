...
<script>
    $(function () {
        var selector = {
            ...
            selectData: [],
            URLS: {
                available: '${ctx!}/ems/exercise/manage/searchWaitUser',
                selected: '${ctx!}/ems/exercise/manage/searchSelectUser',
                save: '${ctx!}/ems/exercise/manage/saveExerciseUser',
                remove: '${ctx!}/ems/exercise/manage/deleteExerciseUser'
            },
...
//                        localStorage.setItem('ARRANGE_USER_count_' + exerciseId, page.total);
                    }
                });
            },
            save: function (data) {
