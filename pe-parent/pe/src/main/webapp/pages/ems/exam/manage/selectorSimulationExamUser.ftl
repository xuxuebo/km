...
<head>
    <meta charset="UTF-8">
    <title>选择器</title>
    <link rel="stylesheet" href="${ctx!}/web-static/proExam/css/pro_exam_plugin_min.css" type="text/css">
    <link rel="stylesheet" href="${ctx!}/web-static/proExam/css/pro_exam_base.css" type="text/css"/>
<#--<script src="${ctx!}/web-static/proExam/js/jquery.placeholder.js" type="text/javascript"></script>-->
                ...
                <div class="pe-panel-header " style="padding: 12px 8px;">
                    <div class="pe-form-cell">
                        ...
                        <div class="pe-control-group" style="margin-right:0;float: right;">
                            <button class="pe-btn pe-btn-blue waitItemFilter" style="margin-right: 270px;">筛选</button>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript" src="${ctx!}/web-static/proExam/js/plugins/jquery-1.9.1.min.js"></script>
<script type="text/javascript" src="${ctx!}/web-static/proExam/js/plugins/jquery.underscore-min.js"></script>
<script type="text/javascript" src="${ctx!}/web-static/proExam/js/plugins/jquery.ztree.core.js"></script>
<script type="text/javascript"
        src="${ctx!}/web-static/proExam/js/plugins/jquery.mCustomScrollbar.concat.min.js"></script>
<script type="text/javascript" src="${ctx!}/web-static/proExam/js/pro_exam_base.js"></script>
<script type="text/javascript" src="${ctx!}/web-static/proExam/js/plugins/layer/layer.js"></script>
<script type="text/javascript" src="${ctx!}/web-static/proExam/js/laydate/laydate.js"></script>
...
<script>
    $(function () {
        var examId = '${(exam.id)!}';
        var isTransient = "${(exam.isTransient)!}";
        var selector = {
            availableData: [],
            selectData: [],
            URLS: {
                available: '${ctx!}/ems/simulationExam/manage/searchWaitUser?id=' + examId,
                selected: '${ctx!}/ems/simulationExam/manage/searchSelectUser?id=' + examId + '&isTransient=' + isTransient,
                save: '${ctx!}/ems/simulationExam/manage/saveExamUser?isTransient=' + isTransient,
                remove: '${ctx!}/ems/simulationExam/manage/deleteExamUser?isTransient=' + isTransient
            },
            ...
            renderSelected: function (data) {
                ...
                $.ajax({
                    ...
                    success: function (page) {
                        ...
                        localStorage.setItem("MOCK_EXAM_USER" + examId, page.total);
                    }
                });
            },
            save: function (data) {
            ...
            remove: function (data) {
                ...
                data = {'id': examId, 'referIds': JSON.stringify(referIds)};
                $.ajax({
                    type: 'post',
                    dataType: 'json',
                    data: data,
