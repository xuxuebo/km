...
import com.fp.cloud.module.ems.model.PaperTemplate;
import com.fp.cloud.module.ems.model.TemplateStrategy;
...
public interface TemplateService extends BaseService<PaperTemplate> {
     ...
     *                         <ul>
     *                         <li>{@linkplain PaperTemplate.PaperStatus#ENABLE 启用}</li>
     *                         <li>{@linkplain PaperTemplate.PaperStatus#DISABLE 停用}</li>
     *                         </ul>
     * @return 受影响的行数
