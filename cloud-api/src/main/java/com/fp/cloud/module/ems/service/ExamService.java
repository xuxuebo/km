...
import com.fp.cloud.module.ems.vo.Es;
...
public interface ExamService extends BaseService<Exam> {
     ...
     *                                            com.fp.cloud.utils.PeException
     *                                            <ul>
     ...
     *                   <ul>
     *                   <li>{@linkplain Exam.CopyField#PAPER_SETTING 试卷信息}</li>
     *                   <li>{@linkplain Exam.CopyField#EXAM_SETTING 考试设置}</li>
     *                   <li>{@linkplain Exam.CopyField#EXAM_USER 考试人员信息}</li>
     *                   <li>{@linkplain Exam.CopyField#EXAM_TIME 考试时间}</li>
     *                   </ul>
     * @return 复制后的实体主键
     ...
     * @param fromType 类型
     *                 <ul>
     *                 <li>{@linkplain BaseModel.FromType#PC PC端}</li>
     *                 <li>{@linkplain BaseModel.FromType#MOBILE 手机端}</li>
     *                 </ul>
     * @return 具体返回考试如下：
     * <ul>
     * <li>未参加的考试</li>
     ...
     * @return 返回字段如下：
     * <ul>
     * <li>{@linkplain ExamResult#score 上次考试成绩}</li>
     ...
     * <li>{@linkplain Paper#itemCount 题目总题数}</li>
     * <li>{@linkplain Paper#mark 题目总分}</li>
     * <li>{@linkplain Es#elt 考试时长}</li>
     * <li>{@linkplain Es#mt 补考设置}</li>
     * </ul>
